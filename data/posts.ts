...
By understanding when to use each format, you can choose the right tool for the right problem rather than simply picking the most popular one. In the next part, we will explore what happens when performance becomes more important than readability: **Binary Serialization**.`,
...

  {
    ...
    content: `# Backend from First Principles — Day 4 (Part 2)
...
This conversion process—serialization and deserialization—is what makes communication between different applications, languages, and systems possible.`,
...

  {
    ...
    content: `# Backend from First Principles — Day 3 (Part 9)
...
In Day 4, I'll explore **Middleware** — what happens before the controller executes, including authentication middleware, authorization, logging, validation, error handling, rate limiting, middleware in Express.js, Guards & Interceptors in NestJS, and Filters in Spring Boot.`,
  ...
  {
    title: "Day 3 — Learning Backend from First Principles (Part 8)",
    slug: "backend-first-principles-day-3-part-8",
    description: "Catch-All Routes: Handling Everything That Doesn't Match. Learn about API error responses, SPA routing, and the difference between 404 and 405.",
    category: "Learning Journey",
    date: "2026-07-17",
    readingTime: "15 min read",
    content: `# Backend from First Principles — Day 3 (Part 8)
...
In Part 9, I'll walk through the complete lifecycle of a request — how routers match requests, route matching order, middleware and route execution, designing scalable route structures, and the routing mindset used by senior backend engineers.`,
  ...
  {
    title: "Day 3 — Learning Backend from First Principles (Part 7)",
    slug: "backend-first-principles-day-3-part-7",
    description: "Route Versioning: Why APIs Need Versions. Explore the four versioning strategies, URL versioning in practice, and the API deprecation lifecycle.",
    category: "Learning Journey",
    date: "2026-07-17",
    readingTime: "16 min read",
    content: `# Backend from First Principles — Day 3 (Part 7)
...
In the next part, I'll bring everything together and conclude the routing series!`,
...

  {
    ...
    content: `# Backend from First Principles — Day 3 (Part 3)
...
In Part 3, I'll begin exploring **Static Routes**, including how frameworks register routes and best practices for organizing them.`,
...

  {
    ...
    date: "2026-07-16",
    readingTime: "12 min read",
    content: `# Backend from First Principles — Day 3 (Part 1)
